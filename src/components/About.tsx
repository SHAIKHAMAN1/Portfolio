        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              I prioritize client collaboration, fostering open communication and ensuring 
              every project meets expectations. I'm very flexible with time zone communications.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>Currently working on react-native project</span>
              </div>
